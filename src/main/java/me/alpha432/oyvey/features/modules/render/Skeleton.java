...
public class Skeleton extends Module
{
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        for (final EntityPlayer player : Skeleton.mc.world.playerEntities) {
            if (player != null && player != Skeleton.mc.getRenderViewEntity() && player.isEntityAlive() && !player.isPlayerSleeping() && (!player.isInvisible() || this.invisibles.getValue()) && this.rotationList.get(player) != null) {
