    ...
    public void doSafetyCheck() {
        if (!Feature.fullNullCheck()) {
            ...
            for (final Entity crystal : crystals) {
                if (crystal instanceof EntityEnderCrystal && DamageUtill.calculateDamage(crystal, (Entity)SafetyManager.mc.player) > 4.0) {
            ...
            if (safe) {
                for (final BlockPos pos : BlockUtil3.possiblePlacePositions(4.0f, false, Managers.getInstance().oneDot15.getValue())) {
