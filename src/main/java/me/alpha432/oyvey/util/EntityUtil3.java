...
public class EntityUtil3 implements Util
{
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil3.mc.player) || (entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName())) || EntityUtil3.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Color getColor(final Entity entity, final int red, final int green, final int blue, final int alpha, final boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            final Killaura killaura = OyVey.moduleManager.getModuleByClass(Killaura.class);
