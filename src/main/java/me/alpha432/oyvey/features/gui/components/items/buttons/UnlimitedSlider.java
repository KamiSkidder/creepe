        ...
        if (this.isHovering(mouseX, mouseY)) {
            ...
            if (this.isRight(mouseX)) {
                if (this.setting.getValue() instanceof Double) {
                    this.setting.setValue(this.setting.getValue().doubleValue() + 1.0);
                }
                else if (this.setting.getValue() instanceof Float) {
                    this.setting.setValue(this.setting.getValue().floatValue() + 1.0f);
                }
                else if (this.setting.getValue() instanceof Integer) {
                    this.setting.setValue(this.setting.getValue().intValue() + 1);
                }
            }
                ...
                this.setting.setValue(this.setting.getValue().doubleValue() - 1.0f);
            }
            else if (this.setting.getValue() instanceof Integer) {
                this.setting.setValue(this.setting.getValue().doubleValue() - 1);
            }
        }
    }
