        ...
        if (trapSlot != -1) {
            switch (this.stage) {
                ...
                case 1: {
                    ...
                    BlockUtil.placeTrapdoor(new BlockPos(TrapPhase.mc.player.posX, TrapPhase.mc.player.posY - 1.0, TrapPhase.mc.player.posZ), EnumHand.MAIN_HAND, false, true, false);
